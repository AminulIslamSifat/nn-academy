  ...
  questions={[
    {
      ...
      options: ["0", "1", "None", "-1"],
      correctIndex: 0,
      explanation: "Identity element for addition is 0: x + 0 = x. For multiply it's 1.",
      randomize: true,
    },
    {
      id: "q2",
      ...
      options: ["Pre-compiled C loops without per-element Python overhead", "They use GPU acceleration", "They skip error checking", "Less memory usage"],
      correctIndex: 0,
      explanation: "ufuncs run tight C loops over contiguous memory, eliminating per-element type dispatch, boxing, and interpreter overhead.",
      randomize: true,
    },
    {
      id: "q3",
      ...
      options: ["No — it's a convenience wrapper only", "Yes, significantly faster", "Only for small arrays", "Only with numba installed"],
      correctIndex: 0,
      explanation: "vectorize is a fancy for-loop. It provides broadcasting and shape handling but NOT speed optimization.",
      randomize: true,
    },
    {
      id: "q4",
      ...
      correctIndex: 0,
      explanation: "frompyfunc always returns object dtype. Cast explicitly with .astype().",
      randomize: true,
    },
    {
      id: "q5",
      ...
      options: ["2", "1", "0", "Error"],
      correctIndex: 0,
      explanation: "nin = number of inputs. np.add takes 2 inputs (a, b).",
      randomize: true,
    },
    {
      id: "q6",
      type: "multiple-choice",
      prompt: "What does the out= parameter in ufuncs avoid?",
      options: ["Memory allocation for the result array", "Type casting", "Broadcasting", "Error checking"],
      correctIndex: 0,
      explanation: "out= writes results into a pre-existing array, avoiding the allocation of a new array each call.",
      randomize: true,
    }
  ]}
/>
